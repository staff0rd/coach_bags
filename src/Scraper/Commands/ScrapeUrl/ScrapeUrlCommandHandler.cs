...
{
    public class ScrapeUrlCommandHandler : IRequestHandler<ScrapeUrlCommand>
    {
        private readonly ChromeDriver _driver;
        private readonly ILogger<ScrapeUrlCommandHandler> _logger;

        public ScrapeUrlCommandHandler(
            ILogger<ScrapeUrlCommandHandler> logger,
            ChromeDriver driver)
        {
            _driver = driver;
            _logger = logger;
        ...
        public async Task<Unit> Handle(ScrapeUrlCommand request, CancellationToken cancellationToken)
        {
            try
            {
